...
def generate_usernames(mod_list):
   ...
   """
   ### WRITE SOLUTION CODE HERE
   new_list = [mod_list[i].replace(" ", "_") for i in range(len(mod_list))]
   return new_list
...
def map_id_to_initial(employee_list):
   ...
   """
   ### WRITE SOLUTION CODE HERE
   new_dict = { employee_list[emp]["name"][0] : employee_list[emp]["id"] for emp in range(len(employee_list))}
   return new_dict
